...
//         .verification-code { display:block; margin:20px 0; font-size:22px; color:#4CAF50; background:#e8f5e9; border:1px dashed #4CAF50; padding:10px; text-align:center; border-radius:5px; font-weight:bold; letter-spacing:2px; }
...
//         .button { display:inline-block; padding:12px 25px; margin:20px 0; background-color:#007BFF; color:white; text-decoration:none; border-radius:5px; text-align:center; font-size:16px; font-weight:bold; transition:background-color 0.3s; }
...
//                 <li>Stay informed by checking out our blog for updates and tips.</li>
//                 <li>Reach out to our support team if you have any questions.</li>
//             </ul>
//             <a href="#" class="button">Get Started</a>
//             <p>If you need any help, don’t hesitate to contact us. We’re here to support you!</p>
//         </div>
//         <div class="footer">
//             <p>&copy; ${new Date().getFullYear()} Your Company. All rights reserved.</p>
//         </div>
